...
const AUTH0_DOMAIN = import.meta.env.VITE_AUTH0_DOMAIN as string || 'YOUR_AUTH0_DOMAIN'
const AUTH0_CLIENT_ID = import.meta.env.VITE_AUTH0_CLIENT_ID as string || 'YOUR_AUTH0_CLIENT_ID'
