...
// Coupe proprement sur une frontière de mot (pas au milieu d'un mot) pour une
// meta description ~155 caractères conforme aux SERP Google 2026.
...
<head>
  ...
  <meta property="og:image:alt" content="Logo IPPOO" />
...
<body>
  <div class="wrap">
    ...
    <hr />
    <p><strong>IPPOO, l'entité N°1 accompagnant les actifs de l'informel en Afrique. Plateforme intégrée, services concrets, impact durable.</strong> IPPOO regroupe 21 espaces thématiques au service des acteurs de l'informel en Afrique. Une propriété de APTDC-Z-UP/TDO/LIMITED, basée à Parakou (Bénin).</p>
    <footer>
...
function indexPage() {
  const title = "Les 21 espaces thématiques IPPOO — Les actifs de l'informel en Afrique";
...
<body>
  <div class="wrap">
    ...
    <p>IPPOO, l'entité N°1 accompagnant les actifs de l'informel en Afrique. Plateforme intégrée, services concrets, impact durable.</p>
    <ul>
...
// Pages internes publiques de l'application (routage par chemin, servies via le
// fallback SPA). Exclut les pages privées (compte, auth, admin, onboarding…).
const APP_PAGES = [
  { path: "adhesion", pr: "0.9" },
  { path: "programmes", pr: "0.8" },
  { path: "business", pr: "0.8" },
  { path: "sante", pr: "0.8" },
  { path: "groupements", pr: "0.8" },
  { path: "investissement", pr: "0.8" },
  { path: "emploi", pr: "0.8" },
  { path: "kaash", pr: "0.8" },
  { path: "bourse", pr: "0.8" },
  { path: "parrainage", pr: "0.7" },
  { path: "apropos", pr: "0.7" },
  { path: "actualites", pr: "0.7" },
  { path: "faq", pr: "0.6" },
  { path: "contact", pr: "0.6" },
  { path: "doleances", pr: "0.5" },
  { path: "mentions", pr: "0.3" },
  { path: "privacy", pr: "0.3" },
  { path: "cgu", pr: "0.3" },
];

// Sitemap principal : accueil + pages internes + index espaces + 21 pages espaces
const urls = [
  { loc: `${BASE}/`, pr: "1.0" },
  ...APP_PAGES.map((p) => ({ loc: `${BASE}/${p.path}`, pr: p.pr })),
